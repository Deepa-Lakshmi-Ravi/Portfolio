...
import "./Home.css";
import Profile from '../../assets/Deepa-2.jpg';
          ...
          <div className="row full-screen align-items-center">
            <div className="content-box col-lg-7">
              <div className="type-box">
                ...
                <h1>Deepalakshmi Ravichandren</h1>
                <p className="text">
                  {text}
                  <Cursor
                ...
                <div className="btn-group">
                  <a
                    href="/src/assets/Deepalakshmi Ravichandren.pdf"
                    target="_blank"
                  >
                    Download CV
                  </a>
                  &nbsp; &nbsp; &nbsp;
                  <a href="mailto:deeparavi2403@gmail.com" target="_blank">
                    Contact
                  </a>
                </div>
                <div className="social-icons">
                  <a
                    href="https://www.instagram.com/deepadevi_30/"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/deepalakshmiravichandran"
                    target="_blank"
                  ...
                  <a
                    ...
                    href="https://github.com/Deepa-Lakshmi-Ravi/"
                    target="_blank"
                  >
